...
cd ~/.local/bin
wget "https://git.zevaryx.com/zevaryx/hasher-rs/releases/download/latest/hasher-gnu-linux-x86_64" -O ~/.local/bin
chmod +x ~/.local/bin/hasher-gnu-linux-x86_64
wget "https://git.zevaryx.com/zevaryx/hasher-rs/releases/download/latest/hasher-gnu-linux-x86_64.sha256" -O ~/.local/bin
